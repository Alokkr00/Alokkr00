...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>Modular quantitative trading framework for automated paper-trading via Alpaca API with a 15-scenario portfolio stress grid and immutable SQLite database triggers.</p>
      <p><b>Tech:</b> <code>Python 3.11</code> <code>FastAPI</code> <code>Alpaca API</code> <code>SQLite</code></p>
  ...
  <tr>
    <td colspan="2" valign="top">
      ...
      <p>🔗 <a href="https://github.com/Alokkr00/Multi_platform_content_uploader">View Repository →</a></p>
    </td>
  </tr>
</table>
